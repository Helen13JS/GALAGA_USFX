	...
	InventoryItem)
{
	...
	if (MunicionRapidaItem)
	{
		...
		GEngine ->AddOnScreenDebugMessage(-1, 5.f, FColor::Green, "La velocidad de las municiones ha aumentado");
		OnMunitionCapsuleConsumed.Broadcast();
		//MunitionCapsuleConsumedEvent.Broadcast();
